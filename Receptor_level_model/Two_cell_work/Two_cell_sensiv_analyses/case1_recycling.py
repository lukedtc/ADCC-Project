...
def tumour_cell_binding(t, z, A0, delta, rtot, kon, koff):
    ...
    dA1 = 2*alpha1*beta_t*(1 - z[0] - z[2] - z[4] - 2*(z[1] + z[3])) - z[0] - delta*alpha1*(1 - z[0] - z[2] - z[4] - 2*(z[1] + z[3]))*z[0] + 2*z[1] - v_int*(z[0]/(z[0] + z[1] + 1 - z[0] - z[2] - z[4] - 2*(z[1] + z[3])))*z[0] + v_rec*z[2]
    dA2 = delta*alpha1*(1 - z[0] - z[2] - z[4] - 2*(z[1] + z[3]))*z[0] - 2*z[1] - v_int*(z[1]/(z[0] + z[1] + 1 - z[0] - z[2] - z[4] - 2*(z[1] + z[3])))*z[1] + v_rec*z[3]
