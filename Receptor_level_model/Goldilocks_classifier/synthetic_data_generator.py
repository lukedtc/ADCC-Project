...
paramaters = saltelli.sample(param_space, 1024)
...
df.to_csv('/Users/lukeheirene/ADCC-Project/Receptor_level_model/Goldilocks_classifier/synthetic_synapse_fc_outputs.csv')